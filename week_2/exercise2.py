...
print(f"Bagging Regressor - Mean Squared Error (MSE): {mse_bagging:.4f}")
print(f"Bagging Regressor - R^2 Score: {r2_bagging:.4f}")

# Plot true vs predicted values for Bagging Regressor
plt.figure(figsize=(6, 6))
plt.scatter(y_test, y_pred_bagging, alpha=0.6, color='b')
...
plt.subplot(1, 2, 2)
plt.tricontourf(x1_test, x2_test, y_pred_bagging, cmap='viridis')
